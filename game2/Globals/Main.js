...
Main.init=function(status,index,type){
           ...
           $("#divContainer").append('<textarea class="label" readonly>'+items[index].label+'</textarea>');
            setAnimation();
           ...
           str = Header.init();
           $("body").html(str);
           $("body").append('<div disabled id="mainContainer"/>');
           ...
           $("#bb47").click(function() {
                      Main.init("text",47, "mission");
           });
	   $("#bb48").click(function() {
                      Main.init("text",48, "mission");
           });
           $("#bb49").click(function() {
                      Main.init("text",49, "mission");
           });
           $("#bb50").click(function() {
                      Main.init("text",50, "mission");
           });
